      ...
      <div class="filtered-items">
        ...
        <?php while($unitquery->have_posts()): ?> <?php $unitquery->the_post() ?>
          ...
          <div class="filtered-item">
            ...
            <div class="filter-item-image-container">
              <a href="#" class="button is-icon is-smaller-light w-inline-block">
            ...
            <div class="filtered-item-details-container">
              <div class="filtered-item-details-wrap">
                <div class="filter-item-detail size">
                  <div>
                    <h5 class="text-size-medium-24 text-weight-semibold">5x10x8</h5>
                    <div class="text-size-tiny-14 text-weight-normal text-color-grey line-height-1-2">Self Storage</div>
                  </div>
              ...
              <div class="filtered-item-details-wrap">
                <div class="filter-item-detail right-flex-end-justified">
                  <div class="filter-detail-price-block">
                    <h5 class="text-size-small-16 text-weight-normal text-color-grey text-style-strikethrough">$90</h5>
                    <h5 class="text-size-medium-24 text-weight-semibold text-color-red">$45</h5>
                  </div>
                  <div class="text-size-tiny-14 text-weight-normal text-color-grey line-height-1-2">Available</div>
                  <div class="reserve-now">
                    <a href="#" class="button is-blue is-icon is-smaller mt-1 w-inline-block">
                      <div class="icon-1x1-small w-embed"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="bi bi-cart-fill" viewbox="0 0 16 16">
...
<?php /**PATH /Users/mikey/Local Sites/white-label-storage-b2c/app/public/wp-content/themes/sage-10/resources/views/partials/home-units.blade.php ENDPATH**/ ?>
    ...
    <div class="col-9">
      <div class="filtered-items">
        ...
        <?php while($unitquery->have_posts()): ?> <?php $unitquery->the_post() ?>
          ...
          <div class="filtered-item <?php if (! ($available_for_move_in)): ?> occupied <?php endif; ?>">
            ...
            <div class="filter-item-image-container position-relative">
              ...
              <?php if(has_post_thumbnail() && current_user_can('mepr_auth')): ?>
...
<?php /**PATH /Users/mikey/Local Sites/white-label-storage-b2c/app/public/app/themes/sage-10/resources/views/partials/home-units.blade.php ENDPATH**/ ?>
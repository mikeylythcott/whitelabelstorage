...
/**
 * Wpgetapi_Api_Importer_License_Handler Class
 */
class Wpgetapi_Api_Importer_License_Handler {

	public $name = 'api_to_posts';
	public $version = WPGETAPIAPITOPOSTSVERSION;
	public $item_id = 3031;
	public $item_name = 'API to Posts';
...
return new Wpgetapi_Api_Importer_License_Handler();

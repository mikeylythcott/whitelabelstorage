...
class WpGetApi_Extras_Actions_Fields {
    ...
    public function get_actions_field_options() {
        ...
        $options = apply_filters( 'wpgetapi_pro_actions_field_options', array(
        ...
        if ( is_plugin_active('wpforms/wpforms.php' ) || is_plugin_active('wpforms-lite/wpforms.php' ) ) {
            ...
            $args = array( 'post_type' => 'wpforms', 'post_status' => 'publish', 'posts_per_page' => -1 );
            $forms = array();
        ...
        if ( is_plugin_active('jetformbuilder/jet-form-builder.php' ) ) {
            ...
            $args = array( 'post_type' => 'jet-form-builder', 'post_status' => 'publish', 'posts_per_page' => -1 );
            $forms = array();

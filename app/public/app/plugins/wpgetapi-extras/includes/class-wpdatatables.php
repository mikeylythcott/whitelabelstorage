...
class WpGetApi_Extras_Wpdatatables {
    ...
    public function get_buttons() {
        ...
        ?>
            ...
            <div class="cmb-td wpdatatables-buttons" data-api-id="<?php _e( $page ); ?>" data-endpoint-id="" data-wpdatatable-id=""  data-wpdatatable-root="">
                
                <?php echo wp_nonce_field('wdtEditNonce', 'wdtNonce'); ?>

                <a target="_blank" class="connected hidden button button-secondary edit-wpdatatable" href="<?php _e( $table_url ); ?>">Edit the wpDataTable</a>
    ...
    public function get_field_options() {
        ...
        $options = apply_filters( 'wpgetapi_pro_wpdatatables_field_options', array(
    ...
    public function exists() {
        ...
        if ( isset( $post->post_content ) && ( has_shortcode( $post->post_content, 'wpdatatable' ) || has_shortcode( $post->post_content, 'wpdatachart' ) ) ) {
            ...
            if ( $regex_matches[2] == 'wpdatachart' ) {
            ...
            if ( $regex_matches[2] == 'wpdatatable' ) {
    ...
    public function formidable_forms_exists( $type, $form ) {
        ...
        if ( isset( $_POST ) && isset( $_POST['frm_action'] ) && $_POST['frm_action'] == 'create' ) {
